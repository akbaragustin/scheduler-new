...
<div class="container">
	<div class="col-xs-12" style="margin-top:5px">
		<div class="pull-right" style="padding-right:20px;padding-top:15px">
			...
			<button type="button" class="btn btn-info waves-effect edit-menu modalFilterKapus" style="background-color:#23589A !important; border-color:#23589A !important">Filter</button>
			</a>
			<a href="#" style="padding-right:8px">
		...
		<div style="background:#FFD700; padding:10px">
				<h3 class="header smaller lighter " style="color:#797C7B; font-weight:bold; color:#0d2d6c ">Agenda Kapus</h3>
			</div>
			<br>
		<br>
...
var  showTable = "{{URL::to(route('frontend.showTableKapus'))}}";
