				...
				<div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								@endif
									...
									<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Pendamping  Struktural</label>
								...
								<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Undangan Lainya Struktural</label>
								...
								foreach ($name_pic as $key => $value) {
								 ...
								 ?>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Undangan Lainya </label>
						...
						<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Data Agenda internal</h3>
										<div class="clearfix">
    ...
    var token = "{{ csrf_token() }}";
		...
		$('.pelaksana').select2({
				...
				// });
				//
				// $('.pelaksana').val(ds).trigger("change");
        ...
        "ajax": {
         ...
         "columns": [
            ...
            { "render": function (data, type, row, meta) {
	                ...
	                var approve = $('<a><button><i>')
	                            .attr('class', "btn btn-success  waves-effect edit-menu material-icons")
		                        .attr('onclick', "changeStatus('?id="+app+"&status="+1+"')")
	                            .text('done_all')
	                            .wrap('<div></div>')
	                            .parent()
	                            .html();
                    var pending = $('<button><i>')
		                        .attr('class', "btn btn-primary waves-effect delete-menu material-icons")
		                        ...
		                        .html();
                    var reject = $('<button>')
		                        .attr('class', "btn btn-warning waves-effect delete-menu material-icons ")
