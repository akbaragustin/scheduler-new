		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-header">
                            <h1>
                                Form Agenda Pejabat Struktural
                                <small>
							...
							<div class="col-xs-12">
								...
								@endif
									...
									<div class="form-group {{$hiddenP}} unitkerja">
										...
										<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5 " name="pelaksana" data-tags="false" data-placeholder="Select an option" style="width:375px">
										<?php
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5 " name="PIC" data-tags="false" data-placeholder="Select an option" style="width:375px">
										<?php
										echo "<option value=''></option>";
						...
						<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Data Agenda Struktural</h3>
										<div class="clearfix">
